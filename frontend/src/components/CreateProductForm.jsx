...
const categories = ["T-shirt", "Jackets", "Shoe", "Glasses", "Jeans", "Suit", "Bag"];
const CreateProductForm = () => {
  ...
  return (
    ...
    >
      <h2 className='text-2xl font-semibold mb-6 text-emerald-600 text-center'>Create New Product</h2>
      <form onSubmit={handleSubmit} className='space-y-4'>
        ...
        <div className='flex items-center'>
          ...
          <label htmlFor="image" className='cursor-pointer bg-gray-700 py-2 px-3 border border-gray-600 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-300 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-4 focus:ring-emerald-500'>
