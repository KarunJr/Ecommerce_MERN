...
import { LogIn, Mail, Lock, ArrowRight, Loader, LucideEye, LucideEyeClosed } from 'lucide-react'
      ...
      >
        <div className='bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
          <form onSubmit={handleSubmit} className=''>
            {/* Email */}
            <div>
              <label htmlFor="email" className='block text-sm font-medium text-gray-300 mt-2'>Email address</label>
              ...
              <div className='mt-1 relative rounded-md shadow-sm'>
                ...
                />
                {
                  isPasswordVisible ? (<LucideEye className='absolute right-2 bottom-2 flex items-center cursor-pointer h-5 w-5'
                    ...
                    <LucideEyeClosed className='absolute right-2 bottom-2 flex items-center cursor-pointer h-5 w-5'
                      onClick={viewPassword} />
                  )
                }
          ...
          <p className='mt-8 text-center text-sm text-gray-400'>
                ...
                <Link to='/signup' className='font-medium text-emerald-400 hover:text-emerald-300'>Signup now <ArrowRight className='inline h-4 w-4'/></Link>
          </p>
        </div>
      </motion.div>
    </div>
